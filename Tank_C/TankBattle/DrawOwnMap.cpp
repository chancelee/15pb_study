...
static void DrawInterface() {
	...
	for (int i = 0; i < 60; i++) {
		PrintChar(i, 0, "¡ù", FOREGROUND_GREEN);
		PrintChar(i, SCREEN_HEIGHT - 1, "¡ù", FOREGROUND_GREEN);
		if (i < MAPCOL) {
	...
	for (int i = 0; i < MAPROW; i++) {
		PrintChar(0, i, "¡ù", FOREGROUND_GREEN);
		PrintChar(MAPCOL - 1, i, "¡ù", FOREGROUND_GREEN);
		PrintChar(60, i, "¡ù", FOREGROUND_GREEN);
		m_gMap[i][0] = WALL_BOUND_ONE;
		m_gMap[i][MAPCOL - 1] = WALL_BOUND_ONE;
	}

	PrintChar(45, 5, "¡ù¡ù¡ù¡ù¡ù¡ù", FOREGROUND_GREEN);
	PrintChar(45, 6, "¡ù¡ù¡ù¡ù¡ù¡ù", FOREGROUND_GREEN);
	PrintChar(45, 14, "¡þ¡þ¡þ¡þ¡þ¡þ", FOREGROUND_GREEN);
	PrintChar(45, 15, "¡þ¡þ¡þ¡þ¡þ¡þ", FOREGROUND_GREEN);
	PrintChar(45, 22, "¡ö¡ö¡ö¡ö¡ö¡ö", FOREGROUND_GREEN);
	PrintChar(45, 23, "¡ö¡ö¡ö¡ö¡ö¡ö", FOREGROUND_GREEN);
	PrintChar(45, 30, "¨ˆ¨ˆ¨ˆ¨ˆ¨ˆ¨ˆ", FOREGROUND_GREEN);
	PrintChar(45, 31, "¨ˆ¨ˆ¨ˆ¨ˆ¨ˆ¨ˆ", FOREGROUND_GREEN);
}
